	...
	<div class="container pg_top v_h">
		...
		<form action="${path }/admin/adminNewsList.do">
			<select name="search" class="inputUnderLine">
				<c:forTokens var="sh" items="n_title, n_writer" delims=","
					varStatus="i">
				...
				name="검색" class="btn btn-outline-secondary btn-sm btn_search"
				value="검색">
		</form>
			...
			<c:if test="${not empty newsList }">
				<c:forEach var="news" items="${newsList }">
					<tr>
						...
						<th><a href="${path }/admin/adminNewsContent.do?nno=${news.nno}">보기</a></th>
					</tr>
				</c:forEach>
			</c:if>
		</table>
		<a class="btn btn-outline-secondary btn-sm add_news"
			href="${path }/admin/newsInsertForm.do">뉴스추가</a>
		<!-- paging -->
		<div>
